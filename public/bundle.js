...
/***/ function(module, exports, __webpack_require__) {
	...
	var JsonTable = __webpack_require__(1);
	...
	var items = [{ name: 'Louise', age: 27, color: 'red' }, { name: 'Margaret', age: 15, color: 'blue' }, { name: 'Lisa', age: 34, color: 'yellow' }];

	var columns = ['name', { key: 'age', label: 'Age' }, { key: 'color', label: 'Colourful', cell: function cell(item, columnKey) {
	...
	React.render(React.createElement(JsonTable, { rows: items, columns: columns }), document.body);
